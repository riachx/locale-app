...
import uploadImage from '../constants/uploadImage.js';
            ...
            <View style={styles.curvedContainer}>
              <View style={styles.insideCurvedContainer}>
                <View style={styles.profileImageContainer}>
                  <Image
                    source={
                      profileImage ? { uri: profileImage } : require('../assets/images/default-pfp.jpg')
                    } // Fallback image
                ...
                <View style={styles.locationContainer}>
                  <View>
                    <Image source={require('../assets/images/pin-logo.png')} style={styles.pinLogo} />
                  </View>
