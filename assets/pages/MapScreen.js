...
import mapstyles from '../../stylesheets/mapstyles.js';
import styles from '../../stylesheets/styles.js';
import commentstyles from '../../stylesheets/commentstyles.js';
      ...
      {loading ? (
        ...
        <>
          ...
          <TouchableOpacity style={mapstyles.floatingButton} activeOpacity={0.7}>
            ...
            >
              <Image source={require('../images/marker.png')} style={mapstyles.buttonImage} />
            </Animated.View>
          </TouchableOpacity>
          ...
          >
            <Image source={require('../images/menu.png')} style={mapstyles.buttonImage} />
          </TouchableOpacity>
        </>
      )}
    </View>
